...
// if the file is dir ,search the index.tpl as default file( MUST NOT A DIR also)
// if the index.tpl not exist or is a dir, give a forbidden response depending on  DirectoryIndex
